...
const StaffDashboard = () => {
  ...
  const LabImage = "https://img.freepik.com/premium-vector/vector-illustration-chemist-white-coat-with-test-tubes-flasks-profession-outline_87693-1723.jpg?w=360";
