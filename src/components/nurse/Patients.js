...
import handleDelete from "./DeletePatient";
        ...
        <Table>
          <TableHead sx={{ backgroundColor: "black" }}>
            <TableRow>
              ...
              <TableCell sx={{ color: "white" }}>SugarLevel</TableCell>
              <TableCell sx={{ color: "white" }}>BloodPressure</TableCell>
          ...
          <TableBody>
            {patients.map((patient, index) => (
              <TableRow key={index}>
                ...
                <TableCell>{patient.sugarlevel}</TableCell>
